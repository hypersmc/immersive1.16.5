...
public class BlockMatcher
{
                                 ...
                                 List<MatcherPredicate> additional)
    {
        for(Preprocessor p : PREPROCESSING)
            found = p.preprocessFoundState(expected, found, world.getServer(), pos);
    ...
    public interface Preprocessor
    {
        BlockState preprocessFoundState(
                BlockState expected, BlockState found, @Nullable MinecraftServer world, @Nullable BlockPos pos
        );
    }
